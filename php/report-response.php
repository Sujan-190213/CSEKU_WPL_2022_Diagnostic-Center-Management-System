...
// echo $row['patient_id'];
  ...
  header("Location:{$hostname}/DCMS/db/html/give-report.php?id=".$_GET['patient_id']."&name=".$_GET['patient_name']);
...
?>
    ...
    <div style=" height:400px;border-radius: 40px; background-color: #f2f2f2; padding: 20px;margin:0px 470px 0px 470px">
    ...
    <div>
        ...
        <form method="GET">
            ...
            <br><br>
            <br>
            <input type="submit" value="Submit" name="submit" style="margin-left:230px;padding:10px 15px 10px 15px;border-radius:10px;">
        </form>
        <br>
